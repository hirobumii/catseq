...
for the authoritative current compiler status, production path, and bounded
cleanup work. Historical milestone plans under `docs/development/` are labelled
explicitly and must not be treated as the active backlog.
